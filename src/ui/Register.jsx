    ...
    >
      <form onSubmit={handleSubmit(submit)}>
        <Stack spacing="4" display={'flex'} justifyContent="space-between">
          ...
          <Stack spacing="6">
            <Stack spacing="5">
              <FormControl isRequired isInvalid={errors.name} w="90%" alignSelf="center">
                <FormLabel htmlFor="name" color="whitesmoke" fontSize={'1.2rem'}>
                  Nombre y apellidos
                </FormLabel>
                <Input
                  bg="gray.300"
              ...
              <FormControl isRequired isInvalid={errors.lastName} w="90%" alignSelf="center">
                <FormLabel htmlFor="username" color="whitesmoke" fontSize={'1.2rem'}>
                  Nombre de usuario
                </FormLabel>
                <Input
                  bg="gray.300"
              ...
              <FormControl isRequired isInvalid={errors.email} w="90%" alignSelf="center">
              ...
              <FormControl isRequired isInvalid={errors.password} w="90%" alignSelf="center">
              ...
              <FormControl isRequired isInvalid={errors.confirm_password} w="90%" alignSelf="center">
                <FormLabel color="whitesmoke" htmlFor="confirm_password" fontSize={'1.2rem'}>
          ...
          <HStack justify="center" spacing="2" pt="5px">
            <Text color="whitesmoke">¿Ya formas parte de nuestra comunidad?</Text>
